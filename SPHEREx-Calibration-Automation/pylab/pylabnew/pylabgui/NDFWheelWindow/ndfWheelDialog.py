...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.combobox_base_NewNdfParameters_passive_NewPosition = QtWidgets.QComboBox(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.combobox_base_NewNdfParameters_passive_NewPosition.sizePolicy().hasHeightForWidth())
        self.combobox_base_NewNdfParameters_passive_NewPosition.setSizePolicy(sizePolicy)
        self.combobox_base_NewNdfParameters_passive_NewPosition.setObjectName("combobox_base_NewNdfParameters_passive_NewPosition")
        self.combobox_base_NewNdfParameters_passive_NewPosition.addItem("")
        self.combobox_base_NewNdfParameters_passive_NewPosition.addItem("")
        self.combobox_base_NewNdfParameters_passive_NewPosition.addItem("")
        self.combobox_base_NewNdfParameters_passive_NewPosition.addItem("")
        self.combobox_base_NewNdfParameters_passive_NewPosition.addItem("")
        ...
        self.combobox_base_NewNdfParameters_passive_NewPosition.addItem("")
        self.combobox_base_NewNdfParameters_passive_NewPosition.addItem("")
        self.gridLayout.addWidget(self.combobox_base_NewNdfParameters_passive_NewPosition, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.combobox_base_NewNdfParameters_passive_NewPosition.setItemText(0, _translate("Form", "1"))
        self.combobox_base_NewNdfParameters_passive_NewPosition.setItemText(1, _translate("Form", "2"))
        self.combobox_base_NewNdfParameters_passive_NewPosition.setItemText(2, _translate("Form", "3"))
        self.combobox_base_NewNdfParameters_passive_NewPosition.setItemText(3, _translate("Form", "4"))
        self.combobox_base_NewNdfParameters_passive_NewPosition.setItemText(4, _translate("Form", "5"))
        self.combobox_base_NewNdfParameters_passive_NewPosition.setItemText(5, _translate("Form", "6"))
        self.combobox_base_NewNdfParameters_passive_NewPosition.setItemText(6, _translate("Form", "7"))
        self.combobox_base_NewNdfParameters_passive_NewPosition.setItemText(7, _translate("Form", "8"))
