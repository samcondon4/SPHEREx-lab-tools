...
class Record:
    ...
    def update(self, data, proc_params=None, meta=None, proc_start_time=None, **kwargs):
        ...
        converted into pandas dataframes in the following manner:
            ...
            2. If the passed in data is a dictionary, it is converted straight into a dataframe with pd.DataFrame(data)
        ...
        The procedure parameters and metadata are each converted directly to a dataframe with
        pd.DataFrame(proc_params/meta, index=[0])
