""" BlueforsController.py

This file is copied and modified from the BlueFTC python package.
Logging has been commented out, the urllib3 InsecureRequestWarning
has been disabled. Note that a wrapper class around BlueFTController has
been implemented for compatibility with SPHERExLabTools in the file 
ControllerWrapper.py.
