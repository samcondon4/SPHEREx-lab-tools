...
# Form implementation generated from reading ui file 'C:/Users/viero/Repositories/SPHEREx-lab-tools-11012022/spherexanalysistools/gui/QTDesigner/alertMessagingWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 971, 641))
        ...
        self.label_SMS = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.label_Email_2 = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.comboBox_Server_Location = QtWidgets.QComboBox(self.layoutWidget1)
        self.comboBox_Server_Location.setMinimumSize(QtCore.QSize(75, 0))
        self.comboBox_Server_Location.setMaximumSize(QtCore.QSize(1000, 30))
        font = QtGui.QFont()
        ...
        self.pushButton_Start.setMaximumSize(QtCore.QSize(1000, 30))
        font = QtGui.QFont()
        ...
        self.pushButton_Stop.setMaximumSize(QtCore.QSize(1000, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_Stop.setFont(font)
        self.pushButton_Stop.setObjectName("pushButton_Stop")
        self.gridLayout.addWidget(self.pushButton_Stop, 0, 2, 1, 1)
        self.pushButton_clearFields = QtWidgets.QPushButton(self.layoutWidget1)
        self.pushButton_clearFields.setMinimumSize(QtCore.QSize(75, 0))
        self.pushButton_clearFields.setMaximumSize(QtCore.QSize(1000, 30))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.pushButton_Refresh = QtWidgets.QPushButton(self.layoutWidget1)
        self.pushButton_Refresh.setMinimumSize(QtCore.QSize(75, 0))
        self.pushButton_Refresh.setMaximumSize(QtCore.QSize(1000, 30))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.pushButton_Refresh.setFont(font)
        self.pushButton_Refresh.setObjectName("pushButton_Refresh")
        self.gridLayout.addWidget(self.pushButton_Refresh, 1, 1, 1, 1)
        self.comboBox_Running = QtWidgets.QComboBox(self.layoutWidget1)
        self.comboBox_Running.setMinimumSize(QtCore.QSize(75, 0))
        self.comboBox_Running.setMaximumSize(QtCore.QSize(1000, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.listView_table = QtWidgets.QListView(self.splitter_2)
        self.listView_table.setMinimumSize(QtCore.QSize(280, 300))
        self.listView_table.setMaximumSize(QtCore.QSize(3000, 900))
        font = QtGui.QFont()
        ...
        self.label_field = QtWidgets.QLabel(self.layoutWidget2)
        self.label_field.setMinimumSize(QtCore.QSize(100, 0))
        self.label_field.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.textEdit_loggingBox = QtWidgets.QTextEdit(self.splitter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_field.setText(_translate("MainWindow", "Field                      Last Measured     Alert When                   Or                                Status"))
